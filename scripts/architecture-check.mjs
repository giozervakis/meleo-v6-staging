...
assert(read('server/relational/app.js').includes("'/api/metrics'"),'metrics endpoint missing')
...
assert(read('server/relational/app.js').includes('/signed'),'temporary signed document access missing')

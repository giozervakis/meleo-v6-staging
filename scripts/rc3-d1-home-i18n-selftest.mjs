...
if(!app.includes('<LanguageSwitcher/>'))fail('global language switch missing')
if(!language.includes('aria-haspopup="menu"'))fail('language switch accessibility missing')

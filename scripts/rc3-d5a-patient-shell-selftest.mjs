...
for(const q of ["patient-rc3d.css","rc3d-patient-page","aria-label={t('patient.metrics.aria')}",'aria-labelledby="rc3d-next-care-title"','role="status" aria-live="polite"','role="tablist"','role="tab"','aria-selected={patientSection'])if(!x.includes(q))f(q)

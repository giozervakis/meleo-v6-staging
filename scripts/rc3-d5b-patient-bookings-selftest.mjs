...
for(const q of ['role="button"','tabIndex={0}','aria-expanded={open===b.id}',"e.key==='Enter'||e.key===' '","aria-label={t('patient.bookingActions.replyAria')}",'aria-busy={recoveryBusy===b.id}'])if(!x.includes(q))f(q)

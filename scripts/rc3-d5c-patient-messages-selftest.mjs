...
for(const q of ['role="group" aria-label="Φίλτρα συνομιλιών"','aria-pressed={filter===','role="log"','aria-relevant="additions text"','aria-label="Γράψε μήνυμα"','aria-busy={sending}'])if(!x.includes(q))f(q)

...
for(const q of ['aria-labelledby="rc3d-care-team-title"','id="rc3d-care-team-title"','role="list"','role="listitem"','aria-label={`Trust score ${p.trust.score}`}','aria-label="Νέος επαγγελματίας"'])if(!x.includes(q))f(q)

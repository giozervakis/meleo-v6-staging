...
for(const q of ["role=\"list\" aria-label={t('patient.metrics.aria')}",'className="patient-care-metric" role="listitem"','aria-labelledby="rc3d-next-care-title" aria-live="polite"'])if(!x.includes(q))f(q)

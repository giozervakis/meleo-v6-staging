...
const x=r('src/features/patient/PatientDashboard.tsx'),c=r('src/features/patient/patient-rc3d.css'),p=JSON.parse(r('package.json')),i=r('src/i18n.ts')
for(const q of [
  'aria-labelledby="rc3d-care-status-title"',
  'id="rc3d-care-status-title"',
  "role=\"list\" aria-label={t('patient.sideRail.status.aria')}",
  'aria-labelledby="rc3d-care-activity-title"',
  'id="rc3d-care-activity-title"',
  'className="patient-activity-list" role="list"',
  'role="listitem"',
  'aria-labelledby="rc3d-quick-actions-title"',
  'id="rc3d-quick-actions-title"',
  'aria-labelledby="rc3d-safety-title"'
])if(!x.includes(q))f(q)
for(const q of ["aria:'Στοιχεία κατάστασης φροντίδας'","aria:'Care status details'"])if(!i.includes(q))f(q)

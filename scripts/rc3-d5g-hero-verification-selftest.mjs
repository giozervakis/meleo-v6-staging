...
for(const q of ['className="verify-email-banner" role="status" aria-live="polite"','aria-busy={busy}','aria-labelledby="rc3d-patient-hero-title"','id="rc3d-patient-hero-title"','className="patient-care-hero-status" role="status" aria-live="polite"',"aria-label={t('patient.hero.memberAria')}"])if(!x.includes(q))f(q)

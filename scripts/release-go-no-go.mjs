...
const report={version:'5.7.0',generatedAt:new Date().toISOString(),decision:blockers.length?'NO-GO':'GO',results,blockers}
fs.mkdirSync('reports',{recursive:true});fs.writeFileSync('reports/release-go-no-go.json',JSON.stringify(report,null,2)); console.table(results); console.log(`\nMELEO v5.7 RELEASE DECISION: ${report.decision}`); process.exitCode=blockers.length?1:0

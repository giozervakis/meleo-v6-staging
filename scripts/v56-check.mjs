...
const a=[fs.readFileSync('server/relational/app.js','utf8'),fs.readFileSync('server/routes/auth-account.routes.js','utf8')].join('\n'),c=fs.readFileSync('server/config.js','utf8'),d=fs.readFileSync('docker-compose.yml','utf8'),p=JSON.parse(fs.readFileSync('package.json','utf8'));

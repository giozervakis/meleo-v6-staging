...
export type AppConfig={env:string;demoAuth:boolean;googleOAuthEnabled:boolean;demoCheckout:boolean;paymentsEnabled:boolean;mailEnabled:boolean;portalEnabled:boolean;plans:Plan[];termsVersion:string;emergencyNumber:string;legal:{company:string;vatNumber:string;address:string;supportEmail:string;dpoEmail:string}}

...
function ProfessionalOnboarding({user,professional,token,onRefresh,setToast,cfg}:any){
 ...
 <div className="onboarding-foot">{t('professionalOnboarding.foot')} <b>Λογαριασμός → Πακέτο → Checkout → Προφίλ → Verification → Admin approval → Public profile.</b></div></div></section>
}

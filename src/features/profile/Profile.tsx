...
>
  ...
  <button
    type="button"
    className="meleo-mobile-profile-book"
    onClick={()=>
      user
        ? startBooking()
        : setView('auth')
